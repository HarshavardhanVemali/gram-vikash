...
FIREBASE_CREDENTIALS_PATH = os.getenv('FIREBASE_CREDENTIALS_PATH', os.path.join(BASE_DIR, 'firebase_admin_sdk.json'))
...
# AWS S3 Configuration (for storing audio input/output)
